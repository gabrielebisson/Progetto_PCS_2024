...
int main()
{
    ...
    sortTracesAndPrintByFracture(prova,"TerrorTraxxPerFract.txt");
    ...
    //                ,Vector3d(8.,-1.,0.)}
    //              };
    // dfn.versori={Vector3d(0.,0.,1.),Vector3d(0.,0.,1.),Vector3d(0.,0.,1.)};
    ...
    //                   ,{Vector3d(8.,-5.,0.),Vector3d(12.,-8.,0.)}
    //                   ,{Vector3d(8.,-3.5,0.),Vector3d(8.,-1.,0.)}
    //                   ,{Vector3d(6.,-6.5,0.),Vector3d(4.,-8.,0.)}
    //                   ,{Vector3d(8.,-6.,0.),Vector3d(8.,-4.,0.)}

    //                   ,{Vector3d(6.,14.,0.),Vector3d(10.,15.,0.)}
    // };
